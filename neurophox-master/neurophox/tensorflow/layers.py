...
class RM(MeshLayer):
    ...
    def get_config(self):
        ...
        #     #'basis': self.basis,
        #     #'bs_error': self.bs_error,
        #     #'theta_init_name': self.theta_init_name,
        #     #'phi_init_name': self.phi_init_name,
        #     #'gamma_init_name': self.gamma_init_name,
        #     #'include_diagonal_phases': self.include_diagonal_phases,
